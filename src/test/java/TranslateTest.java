...
public class TranslateTest
{
    ...
    {
        String result = Colorizer.decorate("<S:FF0080>SOPORTE RGB CHIDO");
    ...
    {
        String result = Colorizer.decorateLegacy("<S:FF0080>SOPORTE RGB CHIDO");
    ...
    {
        String result = Colorizer.decorate("<RB1>ESTE ES UN ARCOIRIS MAMALON</RB>");
//        System.out.println(result);
    ...
    {
        String result = Colorizer.decorateLegacy("<RB1>ESTE ES UN ARCOIRIS MAMALON</RB>");
//        System.out.println(result);
    ...
    {
        String result = Colorizer.decorate("<RB100>ESTE ES UN ARCOIRIS MAMALON</RB>");
    ...
    {
        String result = Colorizer.decorateLegacy("<RB100>ESTE ES UN ARCOIRIS MAMALON</RB>");
    ...
    {
        String result = Colorizer.decorate("<G:2C08BA>Texto genial con un gradientet</G:028A97>");
    ...
    {
        String result = Colorizer.decorateLegacy("<G:2C08BA>Texto genial con un gradientet</G:028A97>");

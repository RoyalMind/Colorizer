...
public class TranslateTest
{
    ...
    {
        String result = Colorizer.translate("<SOLID:FF0080>SOPORTE RGB CHIDO");
    ...
    {
        String result = Colorizer.translateLegacy("<SOLID:FF0080>SOPORTE RGB CHIDO");
    ...
    {
        String result = Colorizer.translate("<RAINBOW1>ESTE ES UN ARCOIRIS MAMALON</RAINBOW>");
//        System.out.println(result);
    ...
    {
        String result = Colorizer.translateLegacy("<RAINBOW1>ESTE ES UN ARCOIRIS MAMALON</RAINBOW>");
//        System.out.println(result);
    ...
    {
        String result = Colorizer.translate("<RAINBOW100>ESTE ES UN ARCOIRIS MAMALON</RAINBOW>");
    ...
    {
        String result = Colorizer.translateLegacy("<RAINBOW100>ESTE ES UN ARCOIRIS MAMALON</RAINBOW>");
    ...
    {
        String result = Colorizer.translate("<GRADIENT:2C08BA>Texto genial con un gradientet</GRADIENT:028A97>");
    ...
    {
        String result = Colorizer.translateLegacy("<GRADIENT:2C08BA>Texto genial con un gradientet</GRADIENT:028A97>");
